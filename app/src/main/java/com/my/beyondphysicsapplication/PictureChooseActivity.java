...
public class PictureChooseActivity extends NewBaseActivity {
    ...
    protected void initConfigUi() {
        pictureChooseActivity_GirdViewAdapter = new PictureChooseActivity_GirdViewAdapter(PictureChooseActivity.this, paths, new PictureChooseActivity_GirdViewAdapter.OnFeedBackListener() {
            @Override
