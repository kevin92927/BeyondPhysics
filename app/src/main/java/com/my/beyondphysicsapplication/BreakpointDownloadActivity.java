...
public class BreakpointDownloadActivity extends NewBaseActivity {
            ...
            public void onClick(View view) {
                switch (view.getId()) {
                    ...
                    case R.id.buttonCancel:
                        BeyondPhysicsManager.getInstance(getBeyondPhysicsManagerParams()).cancelRequestWithRequest(breakpointDownloadRequest, true);
                        downloading = false;
                        break;
                    default:
                        break;
    ...
    private void goToDownload() {
        ...
        if (!NetworkStateTool.isNetworkConnected(BreakpointDownloadActivity.this)) {
            ...
            BeyondPhysicsManager.getInstance(getBeyondPhysicsManagerParams()).addRequest(breakpointDownloadRequest);
        }
    }
    ...
    public static int[] getFileProgress(BaseActivity baseActivity, String url) {
        ...
        CacheItem cacheItem = BeyondPhysicsManager.getInstance(baseActivity.getBeyondPhysicsManagerParams()).getCacheItemByKey(RequestManager.getRequestKey(url, Request.GET), RequestManager.CacheItemTAG.BREAKPOINTDOWNLOADREQUEST);
        if (cacheItem != null) {
