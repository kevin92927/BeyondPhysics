...
public class ChildCommentActivity extends BaseCommentActivity {
    ...
    public void sendComment(final View view, EditText editTextComment) {
        ...
        if (content.equals("")) {
            ...
            Object[] objects = ProgressDialogHelp.unEnabledView(ChildCommentActivity.this, view);
            final ProgressDialog progressDialog = (ProgressDialog) objects[0];
            final String progressDialogKey = (String) objects[1];
            WallpaperDetailsActivityHttpFunction.wallpaperDetailsActivity_commentWallpaper(ChildCommentActivity.this, parentOrChild, content, parent_id, new Request.OnResponseListener<String>() {
                @Override
                public void onSuccessResponse(String response) {
                }
                ...
                @Override
                public void onErrorResponse(String error) {
                    ProgressDialogHelp.enabledView(ChildCommentActivity.this, progressDialog, progressDialogKey, view);
                }
                ...
                public void success(WallpaperDetailsActivity_CommentWallpaper_GsonModel.Data data) {
                    if (data == null) {
                        ...
                        BaseActivity.showShortToast(ChildCommentActivity.this, data.getTips());
                        doRefresh();
                    }
                    ProgressDialogHelp.enabledView(ChildCommentActivity.this, progressDialog, progressDialogKey, view);
                }
