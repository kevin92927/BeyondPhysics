        ...
        if (!NetworkStateTool.isNetworkConnected(baseActivity)) {
            ...
            MyStringRequest myStringRequest = new MyStringRequest(url, Request.POST, baseActivity.activityKey, new Request.OnResponseListener<String>() {
                ...
                public Map<String, String> getBodyParams() {
                    ...
                    EncryptionTool.addParamWithEncryption(bodyParams, "upOrDown", "down");
                    return bodyParams;
                }
            };
            BeyondPhysicsManager.getInstance(NewBaseActivity.getBeyondPhysicsManagerParams(baseActivity)).addRequestWithSort(myStringRequest);
        }
    }
