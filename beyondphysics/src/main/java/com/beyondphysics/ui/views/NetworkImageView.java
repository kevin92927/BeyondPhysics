...
public class NetworkImageView extends AppCompatImageView {
    ...
    private void init(Context context) {
        ...
        activity = BaseActivity.getActivityByContext(this.context);
    }
    ...
    private void doBitmapRequest(BitmapRequest_Default_Params bitmapRequest_Default_Params, boolean canFilter) {
        ...
        bitmapRequest = new BitmapRequest_Default(urlString, bitmapRequest_Default_Params.getTag(), onResponseListener, bitmapRequest_Default_Params.getPriority(), bitmapRequest_Default_Params.getConnectTimeoutMs(), bitmapRequest_Default_Params.getReadTimeoutMs(), bitmapRequest_Default_Params.isCacheInDisk(), bitmapRequest_Default_Params.getWidth(), bitmapRequest_Default_Params.getHeight(), bitmapRequest_Default_Params.getScaleType(), getBitmapConfig(), bitmapRequest_Default_Params.isCacheInMemory(), bitmapRequest_Default_Params.getOnDownloadProgressListener(), bitmapRequest_Default_Params.getContext());
     ...
     * return NotNull
     */
    private BeyondPhysicsManager getBeyondPhysicsManager() {
        BeyondPhysicsManager beyondPhysicsManager = null;
        if (activity != null && activity instanceof BaseActivity) {
            BaseActivity baseActivity = (BaseActivity) activity;
            beyondPhysicsManager = BeyondPhysicsManager.getInstance(baseActivity.getBeyondPhysicsManagerParams());
        } else {
            beyondPhysicsManager = BeyondPhysicsManager.getInstance(BaseActivity.getDefaultBeyondPhysicsManagerParams(context));
            FileTool.needShowAndWriteLogToSdcard(RequestManager.openDebug, RequestManager.logFileName, "NetworkImageView_getBeyondPhysicsManager:context异常", null, 1);
        }
    ...
    private void addOrCancelBitmapRequest(int type, BitmapRequest<?> bitmapRequest) {
        RequestManager requestManager = getBeyondPhysicsManager().getRequestManager();
