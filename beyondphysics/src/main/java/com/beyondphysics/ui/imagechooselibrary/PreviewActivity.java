...
public class PreviewActivity extends BaseActivity {
    ...
    public class MyPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            NetworkImageView networkImageView = new NetworkImageView(PreviewActivity.this);
            ...
            NetworkImageViewHelp.getImageFromDiskCache(networkImageView, selectImagePaths.get(position), 1, activityKey, 0, 0);
