        ...
        if (viewItem != null) {
            if (viewItem.getViewType() == ViewItem.VIEW_TYPE_NORMAL_ITEM_TYPE1) {
                ...
                if (imageItem != null) {
                    ...
                    NetworkImageViewHelp.getImageFromDiskCacheWithNewParams(networkImageView, imageItem.getPath(), 1, chooseImageActivity.activityKey, itemWidth, itemWidth, R.mipmap.beyondphysics_activity_chooseimage_default_loading, R.mipmap.beyondphysics_activity_chooseimage_default_loading);
