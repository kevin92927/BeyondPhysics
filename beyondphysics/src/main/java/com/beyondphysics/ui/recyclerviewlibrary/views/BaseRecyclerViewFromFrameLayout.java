                ...
                public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                    if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                        if (requestStatusItem != null) {
                            BeyondPhysicsManager.getInstance(baseActivity.getBeyondPhysicsManagerParams()).removeRequestStatusItem(requestStatusItem);
                            requestStatusItem = null;
                        }

                    } else {
                        if (requestStatusItem == null) {
                            requestStatusItem = BeyondPhysicsManager.getInstance(baseActivity.getBeyondPhysicsManagerParams()).addRequestStatusItem(RequestStatusItem.STATUS_PAUSE, RequestStatusItem.KIND_BITMAP_REQUEST, baseActivity.activityKey);
                        }
                    }
                }
            });
